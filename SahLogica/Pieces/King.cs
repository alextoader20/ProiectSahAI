...
namespace SahLogica
{
    public class King : Piece
    {
        ...
        private bool CanCastleKingSide(Position from, Board board)
        {
            ...
            Position[] betweenPoitions = new Position[] { new Position(from.Row, 5), new Position(from.Row, 6) };

            return IsUnmovedRook(rookPos, board) && AllEmpty(betweenPoitions, board);
        }
